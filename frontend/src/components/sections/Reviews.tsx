...
const reviews = [
  ...
  },
  {
    name: "كريم ت.",
    city: "طنجة",
    text: "خديتها للكامبينغ فالغابة — تتطوى فثواني و ما كتاخدش بلاصة. شكراً SHAMANGARO على هاد المنتج!",
  },
  {
    name: "نادية ر.",
    city: "أكادير",
    text: "شريت Pack Family — 3 كراسي للعائلة. الأولاد فرحانين و أنا مرتاحة. الدفع عند الإستلام طمنّي بزاف.",
  },
  {
    name: "حمزة ف.",
    city: "فاس",
    text: "كنت متردد لكن ملي وصلاتني — الجودة رائعة بصراح. كنوصي بيها للجميع.",
  },
];
